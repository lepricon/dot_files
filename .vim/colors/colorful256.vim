...
let g:colors_name = "colorful256"
 ...
 highlight Normal       cterm=none    ctermfg=249 ctermbg=NONE  gui=none    guifg=#b2b2b2 guibg=NONE
 highlight Special      cterm=none    ctermfg=105 ctermbg=NONE  gui=none    guifg=#8787ff guibg=NONE
 highlight Comment      cterm=none    ctermfg=3   ctermbg=NONE  gui=none    guifg=#808000 guibg=NONE
 highlight Constant     cterm=none    ctermfg=9   ctermbg=NONE  gui=none    guifg=#ff0000 guibg=NONE
 highlight LineNr       cterm=none    ctermfg=48  ctermbg=NONE  gui=none    guifg=#00ff87 guibg=NONE
 highlight Number       cterm=none    ctermfg=209 ctermbg=NONE  gui=none    guifg=#ff875f guibg=NONE
 highlight PreProc      cterm=none    ctermfg=10  ctermbg=NONE  gui=none    guifg=#ff00ff guibg=NONE
 highlight Statement    cterm=none    ctermfg=51  ctermbg=NONE  gui=none    guifg=#00ffff guibg=NONE
 highlight Type         cterm=none    ctermfg=39  ctermbg=NONE  gui=none    guifg=#00afff guibg=NONE
 highlight Error        cterm=none    ctermfg=9   ctermbg=NONE  gui=none    guifg=#ff0000 guibg=NONE
 highlight Identifier   cterm=none    ctermfg=207 ctermbg=NONE  gui=none    guifg=#ff5fff guibg=NONE
 highlight SpecialKey   cterm=none    ctermfg=36  ctermbg=NONE  gui=none    guifg=#00af87 guibg=NONE
 highlight NonText      cterm=none    ctermfg=164 ctermbg=NONE  gui=none    guifg=#df00df guibg=NONE
 highlight Directory    cterm=none    ctermfg=34  ctermbg=NONE  gui=none    guifg=#00af00 guibg=NONE
 highlight ErrorMsg     cterm=none    ctermfg=9   ctermbg=NONE  gui=none    guifg=#ff0000 guibg=NONE
 highlight MoreMsg      cterm=none    ctermfg=34  ctermbg=NONE  gui=none    guifg=#00af00 guibg=NONE
 highlight Title        cterm=none    ctermfg=199 ctermbg=NONE  gui=none    guifg=#ff00af guibg=NONE
 highlight WarningMsg   cterm=none    ctermfg=9   ctermbg=NONE  gui=none    guifg=#ff0000 guibg=NONE
 highlight DiffDelete   cterm=none    ctermfg=207 ctermbg=NONE  gui=none    guifg=#ff5fff guibg=NONE
...
"   highlight CursorLine  cterm=bold ctermfg=NONE ctermbg=none gui=bold guifg=NONE guibg=NONE
endif
...
if exists('loaded_taglist')
   ...
   highlight TagListTitle    cterm=none ctermfg=199 ctermbg=16 gui=none guifg=#ff00af guibg=NONE
